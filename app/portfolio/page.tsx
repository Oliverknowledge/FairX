  ...
  return (
    <article className="min-w-0 overflow-hidden rounded-2xl border border-(--border) bg-white shadow-[0_10px_30px_rgba(15,23,42,.04)]">
      <div className="p-5 sm:p-6">
        ...
        <div className="mt-6 grid grid-cols-3 gap-px overflow-hidden rounded-xl bg-(--border)"><OutcomeStat label="SIDE" value={position.side} /><OutcomeStat label="ENTRY" value={refunded ? "Not accepted" : formatPrice(position.priceMicros).replace("¢", "%")} /><OutcomeStat label="STAKE" value={formatSol(position.stakeLamports)} /></div>
